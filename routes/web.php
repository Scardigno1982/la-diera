...
// });
    ...
    // Descargar planillas
    Route::get('/planillas', 'LocalizacionController@planillas')->name('planillas');
    Route::get('/planillas2018', 'LocalizacionController@planillas2018')->name('planillas2018');
    Route::get('/planillas2019', 'LocalizacionController@planillas2019')->name('planillas2019');
    Route::get('/planillasI2020', 'LocalizacionController@planillasI2020')->name('planillasI2020');
    Route::get('/planillasF2020', 'LocalizacionController@planillasF2020')->name('planillasF2020');
    Route::get('/planillasF2021', 'LocalizacionController@planillasF2021')->name('planillasF2021');
