...
<body>
  ...
  <div id="main-content">
    <div class="container">
    	<div class="col-lg-12"><h4>FORMULARIOS DEL RELEVAMIENTO FINAL 2019</h4></div>	<br>
      <div class="row">
        <div class="big-box">
          ...
          <div class="col-lg-12">
              ...
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.9s">
                  <div class="align-center">
                   {{-- style="color:Tomato">	 --}}
                    <a href="pdf/Final2019/01 Ed. Inicial.pdf" download><i class="fa fa-file-pdf-o fa-2x"></i></a>
            ...
            <div class="col-md-3">   	
              ...
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.9s">
                  <div class="align-center">
                    <a href="pdf/Final2019/02 Ed. Primaria.pdf" download><i class="fa fa-file-pdf-o fa-2x"></i></a>
            ...
            <div class="col-md-3">
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.6s">
                  <div class="align-center">                    
                    <a href="pdf/Final2019/03 Ed. Secundaria.pdf" download><i class="fa fa-file-pdf-o fa-2x"></i></a>
            ...
            <div class="col-md-3">
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.6s">
                  <div class="align-center">                    
                    <a href="pdf/Final2019/04 Ed. Superior.pdf" download><i class="fa fa-file-pdf-o fa-2x"></i></a>
         ...
         <div class="col-lg-12">
            <div class="col-md-3">              
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.9s">
                  <div class="align-center">
                    <a href="pdf/Final2019/05 Ed de Adultos (EPA).pdf" download><i class="fa fa-file-pdf-o fa-2x"></i></a>
            ...
            <div class="col-md-3">   	
              ...
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.9s">
                  <div class="align-center">
                    <a href="pdf/Final2019/06 CENS-CEBAS.pdf" download><i class="fa fa-file-pdf-o fa-2x"></i></a>
            ...
            <div class="col-md-3">
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.6s">
                  <div class="align-center">                    
                    <a href="pdf/Final2019/07 Ed. Especial.pdf" download><i class="fa fa-file-pdf-o fa-2x"></i></a>
            ...
            <div class="col-md-3">
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.6s">
                  <div class="align-center">                    
                    <a href="pdf/Final2019/08 Ed. Artística.pdf" download><i class="fa fa-file-pdf-o fa-2x"></i></a>
         ...
         <div class="col-lg-12">
            <div class="col-md-3">              
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.9s">
                  <div class="align-center">
                    <a href="pdf/Final2019/09 Form. Profesional.pdf" download><i class="fa fa-file-pdf-o fa-2x"></i></a>
            ...
            <div class="col-md-3">   	
              ...
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.9s">
                  <div class="align-center">
                    <a href="pdf/Final2019/10 Centro Ed. Complementario.pdf" download><i class="fa fa-file-pdf-o fa-2x"></i></a>
            ...
            <div class="col-md-3">
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.6s">
                  <div class="align-center">                    
                    <a href="pdf/Final2019/11 Centros de Ed. Física.pdf" download><i class="fa fa-file-pdf-o fa-2x"></i></a>
            ...
            <div class="col-md-3">
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.6s">
                  <div class="align-center">                    
                    <a href="pdf/Final2019/12 CIEs.pdf" download><i class="fa fa-file-pdf-o fa-2x"></i></a>
