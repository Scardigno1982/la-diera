...
<body>
          ...
          <div class="col-md-8">
            <div class="dropdown">
              <ul class="nav nav-pills">                                
                <li class="active"> <a href="/home">Volver</a></li>                     
              </ul>
            </div>
          </div>
        </div>
  ...
  <div id="main-content">
    <div class="container">
    	<div class="col-lg-12"><h4>FORMULARIOS DEL RELEVAMIENTO INICIAL 2020</h4></div>	<br>
      <div class="row">
        <div class="big-box">
          ...
          <div class="col-lg-12">
              ...
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.9s">
                  <div class="align-center">
                   {{-- style="color:Tomato">	 --}}
                    <a href="pdf/Inicial2020/01 Ed. Inicial.pdf" download><i class="fa fa-file-pdf-o fa-2x"></i></a>
            ...
            <div class="col-md-3">   	
              ...
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.9s">
                  <div class="align-center">
                    <a href="pdf/Inicial2020/02 Ed. Primaria.pdf" download><i class="fa fa-file-pdf-o fa-2x"></i></a>
            ...
            <div class="col-md-3">
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.6s">
                  <div class="align-center">                    
                    <a href="pdf/Inicial2020/03 Ed. Secundaria.pdf" download><i class="fa fa-file-pdf-o fa-2x"></i></a>
            ...
            <div class="col-md-3">
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.6s">
                  <div class="align-center">                    
                    <a href="pdf/Inicial2020/04 Ed. Superior.pdf" download><i class="fa fa-file-pdf-o fa-2x"></i></a>
         ...
         <div class="col-lg-12">
            <div class="col-md-3">              
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.9s">
                  <div class="align-center">
                    <a href="pdf/Inicial2020/05 Ed. de Adultos (EPA).pdf" download><i class="fa fa-file-pdf-o fa-2x"></i></a>
            ...
            <div class="col-md-3">   	
              ...
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.9s">
                  <div class="align-center">
                    <a href="pdf/Inicial2020/06 CENS-CEBAS.pdf" download><i class="fa fa-file-pdf-o fa-2x"></i></a>
            ...
            <div class="col-md-3">
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.6s">
                  <div class="align-center">                    
                    <a href="pdf/Inicial2020/07 Ed. Especial.pdf" download><i class="fa fa-file-pdf-o fa-2x"></i></a>
            ...
            <div class="col-md-3">
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.6s">
                  <div class="align-center">                    
                    <a href="pdf/Inicial2020/08 Ed. Artística.pdf" download><i class="fa fa-file-pdf-o fa-2x"></i></a>
         ...
         <div class="col-lg-12">
            <div class="col-md-3">              
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.9s">
                  <div class="align-center">
                    <a href="pdf/Inicial2020/09 Form. Profesional.pdf" download><i class="fa fa-file-pdf-o fa-2x"></i></a>
            ...
            <div class="col-md-3">   	
              ...
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.9s">
                  <div class="align-center">
                    <a href="pdf/Inicial2020/10 Centro Ed. Complementario.pdf" download><i class="fa fa-file-pdf-o fa-2x"></i></a>
            ...
            <div class="col-md-3">
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.6s">
                  <div class="align-center">                    
                    <a href="pdf/Inicial2020/11 Centros de Ed. Física.pdf" download><i class="fa fa-file-pdf-o fa-2x"></i></a>
            ...
            <div class="col-md-3">
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.6s">
                  <div class="align-center">                    
                    <a href="pdf/Inicial2020/12 CIEs.pdf" download><i class="fa fa-file-pdf-o fa-2x"></i></a>
