...
*/
  ...
  {  
      ...
      $fecha = Carbon::now('America/Buenos_Aires'); //date("Y-m-d H:i:s", time());  // calculamos fecha y hora a usar x las confirmaciones
      ...
      $migracion=DB::Select("select id_localizacion_periodo from datos_formulario df join localizaciones_periodo lp using (id_localizacion_periodo)
                              where (df.c_estado_formulario between 80 and 99) and df.updated_at + '1 day'::interval < now() and id_periodo=:id_periodo"
      ...
      $migracion=collect($migracion);
      // Verificamos que halla localizaciones para migrar
      if ($migracion->isEmpty() )
      {
        Session::flash('flash_message_error','No hay formularios completos para confirmar ('. $fecha->Format('d/m/Y H:i:s') .')');
        return back();
      }
      $msg=[];
      // PRECESAMOS LAS LOCALZACIONES QUE SE deben confirmar ($migracion)
      foreach ($migracion as $key => $loc)
      {
          // cofirmar localizacion
          $formulario = New DatosFormularioController($loc->id_localizacion_periodo);

          $msg2 = ($formulario->confirmarformulario()) ? 'confirmado' : 'no completo' ;  // intentamos confirmar el formulario
          // $msg2 = $formulario->c_estado_formulario;  //recuperamos el estado del formulario despues de consistirlo
      ...
      $msg2="RELEVAMIENTO ".$p->periodo." : CONFIRMAR PENDIENTES COMPLETADO : ". $migracion->count() ." Formularios confirmados en "
  ...
  {
      $servicios_educativos = p_servicios_educativos::select('p_servicios_educativos.*', 'partidos.c_departamento', 'partidos.nombre as distrito', 'users.username', 'users.name')
      ->join('partidos', 'p_servicios_educativos.c_departamento', '=', 'partidos.c_departamento')      
      ->join('users', 'users.id', '=', 'p_servicios_educativos.id_usuario')            
  ...
  { 
      ...
      $servicios_educativos = p_servicios_educativos::select('p_servicios_educativos.*', 'partidos.c_departamento', 'partidos.nombre as distrito', 'users.username', 'users.name', 'periodos.periodo')
      ->join('partidos', 'p_servicios_educativos.c_departamento', '=', 'partidos.c_departamento')      
      ->join('users', 'users.id', '=', 'p_servicios_educativos.id_usuario')
...
public function planillas() 
    { return view('descargaplanillasI2023'); }

public function planillas2018() 
    { return view('descargaplanillasF2018'); }

public function planillas2019() 
    { return view('descargaplanillasF2019'); }

public function planillasI2020() 
    { return view('descargaplanillasI2020'); }

public function planillasF2020() 
    { return view('descargaplanillasF2020'); }

public function planillasF2021() 
    { return view('descargaplanillasF2021'); }
...
{    
  ...
  { return redirect('/home'); }
    ...
    from indicadores i 
      ...
      where i.indicador = '3.16' and i.subind='T' and i.idperiodo in (76,80)  
        and i.dependencia= (select max(dependencia) from indicadores 
                                       where indicador = '3.16' and subind='T' and idperiodo in (76,80) and dominio='C' and cod_dominio='".$id."') --dependencia
        ...
        and i.oferta in (select (oferta) from indicadores where indicador = '3.16' and subind='T' 
                                                      and idperiodo in (76,80) and oferta <> 302 and dominio='C' and cod_dominio='".$id."') --oferta de la escuela
     order by descripcionoferta, orden");
      ...
      from indicadores i 
        ...
        join ts_cod_dominios cd on cd.Dominio=i.dominio
        join ts_cod_ofertas co on co.oferta=i.oferta
        where i.indicador = '3.17' and i.subind='T' and i.idperiodo in (76, 80)
          and i.dependencia= (select max(dependencia) from indicadores where  indicador = '3.17' and subind='T'
          and idperiodo in (76, 80)and dominio='C' and cod_dominio='".$id."') --dependencia
          and ((i.dominio='P' and i.cod_dominio='1')  -- provincia
                  or (i.dominio='R' and i.cod_dominio='".$cod_reg."') --reg de la esc.
                  or (i.dominio='D' and i.cod_dominio='".$cod_dto."') --cod dto
                  or (i.dominio='C' and i.cod_dominio='".$id."') --idserv
                )
          and i.oferta in (select (oferta) from indicadores where  indicador = '3.17' and subind='T' and idperiodo in (76, 80)
        ...
        from indicadores i 
          ...
          join ts_cod_dominios cd on cd.Dominio=i.dominio
          join ts_cod_ofertas co on co.oferta=i.oferta
          where i.indicador = '3.18' and i.subind='T' and i.idperiodo in (76, 80)  
            ...
            and i.oferta in (select (oferta) from indicadores where  indicador = '3.18' and subind='T' and idperiodo in (76, 80)
                      and oferta <>302 and dominio='C'
                            and cod_dominio='".$id."'  
                            ) --oferta de la escuela  
            order by descripcionoferta, orden");
      ...
      from indicadores i 
        ...
        from indicadores i 
          ...
          join ts_cod_dominios cd on cd.Dominio=i.dominio
          join ts_cod_ofertas co on co.oferta=i.oferta
          where i.indicador = '4.41' and i.subind='T' and i.idperiodo in (76, 80)
            ...
            and i.oferta in (select (oferta) from indicadores where  indicador = '4.41' and subind='T' and idperiodo in (76, 80) 
                      and oferta <>302 and dominio='C'
                            and cod_dominio='".$id."'  
                            ) --oferta de la escuela
                            order by descripcionoferta, orden");
        ...
        from indicadores i 
          ...
          join ts_cod_dominios cd on cd.Dominio=i.dominio
          join ts_cod_ofertas co on co.oferta=i.oferta
          where i.indicador = '3.20' and i.subind='T' and i.idperiodo in (76,80)
            ...
            and i.oferta in (select (oferta) from indicadores where  indicador = '3.20' and subind='T' and idperiodo in (76,80) 
                      and oferta <>302 and dominio='C'
                            and cod_dominio='".$id."'  
                            ) --oferta de la escuela
                      order by descripcionoferta, orden");
        ...
        from indicadores i 
          ...
          join ts_cod_dominios cd on cd.Dominio=i.dominio
          join ts_cod_ofertas co on co.oferta=i.oferta
          where i.indicador = '3.21' and i.subind='T' and i.idperiodo in (74, 78)
            and i.dependencia= (select max(dependencia) from indicadores where  indicador = '3.21' and subind='T'
            and idperiodo in (74, 78)and dominio='C' and cod_dominio='".$id."') --dependencia
            and ((i.dominio='P' and i.cod_dominio='1')  -- provincia
                    or (i.dominio='R' and i.cod_dominio='".$cod_reg."') --reg de la esc.
                    or (i.dominio='D' and i.cod_dominio='".$cod_dto."') --cod dto
                    or (i.dominio='C' and i.cod_dominio='".$id."') --idserv
                  )
            and i.oferta in (select (oferta) from indicadores where  indicador = '3.21' and subind='T' and idperiodo in (74, 78) 
                      and oferta <>302 and dominio='C'
                            and cod_dominio='".$id."'  
                            ) --oferta de la escuela
                            order by descripcionoferta, orden");                               
         ...
         // 3.16
            for($i = 1;$i<=collect($data316)->count();$i++) {            
             if ($i==1){ 
               $chart316_1=collect($data316)->where('descripcionoferta', '===', $data316[0]->descripcionoferta);
                ...
                ->dataset('RA 2017', $valores_3_16_1_76) 
                ->dataset('RA 2018', $valores_3_16_1)                
              ...
              elseif ($i==9){
                ...
                ->loaderColor ('#FD7424')               
                ->colors(['#FD7424', '#00FFC5', '#0038FF', '#00FF05', '#1B9024', '#F000FF'])       
                ->dataset('RA 2017', $valores_3_16_2_76)
                ->dataset('RA 2018', $valores_3_16_2)
               ...
               elseif ($i==17){
                ...
                ->loaderColor ('#FD7424')               
                ->colors(['#FD7424', '#00FFC5', '#0038FF', '#00FF05', '#1B9024', '#F000FF'])                 
                ->dataset('RA 2017', $valores_3_16_3_76)
                ->dataset('RA 2018', $valores_3_16_3)
          ...
          for($i = 1;$i<=collect($data317)->count();$i++) {
            if ($i==1){ $chart317_1=collect($data317)->where('descripcionoferta', '===', $data317[0]->descripcionoferta);
               ...
               ->dataset('RA 2017', $valores_3_17_1_76) 
               ->dataset('RA 2018', $valores_3_17_1)                
             ...
             elseif ($i==9){
               ...
               ->loaderColor ('#fdd043')            
               ->colors(['#fdd043', '#e2598b', '#aa5c9f', '#7f4782'])       
               ->dataset('RA 2017', $valores_3_17_2_76) 
               ->dataset('RA 2018', $valores_3_17_2)                       
              ...
              elseif ($i==17){
               ...
               ->loaderColor ('#fdd043')              
               ->colors(['#fdd043', '#e2598b', '#aa5c9f', '#7f4782'])              
               ->dataset('RA 2017', $valores_3_17_3_76) 
               ->dataset('RA 2018', $valores_3_17_3)   
    ...
    for($i = 1;$i<=collect($data318)->count();$i++) {
     ...
     ->dataset('RA 2017', $valores_3_18_1_76) 
     ->dataset('RA 2018', $valores_3_18_1)          
   ...
   elseif ($i==9){
     ...
     ->loaderColor ('#9764c7')                  
     ->colors(['#9764c7', '#099a97'])   
     ->dataset('RA 2017', $valores_3_18_2_76) 
     ->dataset('RA 2018', $valores_3_18_2)                
    ...
    elseif ($i==17){
     ...
     ->loaderColor ('#9764c7')                   
     ->colors(['#9764c7', '#099a97'])           
     ->dataset('RA 2017', $valores_3_18_3_76) 
     ->dataset('RA 2018', $valores_3_18_3)    
...
for($i = 1;$i<=collect($data320)->count();$i++) {
  if ($i==1){ 
    $chart320_1=collect($data320)->where('descripcionoferta', '===', $data320[0]->descripcionoferta);    
     ...
     ->dataset('RA 2017', $valores_3_20_1_76)
     ->dataset('RA 2018', $valores_3_20_1)      
   ...
   elseif ($i==9){
    ...
    ->loaderColor ('#556fb5')                 
    ->colors(['#556fb5', '#e4508f', '#aeddcd'])        
    ->dataset('RA 2017', $valores_3_20_2_76)     
    ->dataset('RA 2018', $valores_3_20_2)       
   ...
   elseif ($i==17){
    ...
    ->loaderColor ('#556fb5')                 
     ->colors(['#556fb5', '#e4508f', '#aeddcd'])       
    ->dataset('RA 2017', $valores_3_20_3_76)     
    ->dataset('RA 2018', $valores_3_20_3)       
...
if ($i==1){ 
  $chart321_1=collect($data321)->where('descripcionoferta', '===', $data321[0]->descripcionoferta);
   ...
   ->dataset('Final 2016', $valores_3_21_1_74) 
   ->dataset('Final 2017', $valores_3_21_1)    
 ...
 elseif ($i==9){
   ...
   ->loaderColor ('#FD7424')               
   ->colors(['#e4c666', '#247e6c'])
   ->dataset('Final 2016', $valores_3_21_2_74) 
   ->dataset('Final 2017', $valores_3_21_2)      
  ...
  elseif ($i==17){
   ...
   ->loaderColor ('#FD7424')               
   ->colors(['#e4c666', '#247e6c'])
   ->dataset('Final 2016', $valores_3_21_3_74) 
   ->dataset('Final 2017', $valores_3_21_3)           
  ...
  for($i = 1;$i<=collect($data441)->count();$i++) {
    if ($i==1){ 
      $chart441_1=collect($data441)->where('descripcionoferta', '===', $data441[0]->descripcionoferta);
       ...
       ->dataset('RA 2017', $valores_4_41_1_76) 
       ->dataset('RA 2018', $valores_4_41_1)                
     ...
     elseif ($i==9){
       ...
       ->loaderColor ('#6b7b8e')                 
       ->colors(['#6b7b8e', '#8fbbaf', '#acdeaa', '#d6f8b8'])
       ->dataset('RA 2017', $valores_4_41_2_76)
       ->dataset('RA 2018', $valores_4_41_2)
      ...
      elseif ($i==17){
       ...
       ->loaderColor ('#6b7b8e')                 
       ->colors(['#6b7b8e', '#8fbbaf', '#acdeaa', '#d6f8b8'])        
        ->dataset('RA 2017', $valores_4_41_3_76)
        ->dataset('RA 2018', $valores_4_41_3)
