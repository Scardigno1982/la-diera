...
public function consistencia_27 ($cons,$ncuadro,$c_datosno0)
    ...
    */
    ...
    public function cargar_input($input)  {
       ...
       if ($this->c_estado_formulario==70)   // si el formulario estaba vacio los ponemos en carga, para  que se puedan aplicar las  consistencias
            {   $this->c_estado_formulario=40;
            }

    	foreach ($input as $ncua => $cuadro)  { 
                if ($this->cuadros[$ncua]->c_estado_cuadro==70) // 70= Vacio (si estaba vacio lo pasamos a En carga)
                        {
